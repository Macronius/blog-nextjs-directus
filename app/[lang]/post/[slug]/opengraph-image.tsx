...
export default async function og({
  ...
  return new ImageResponse(
    (
      <div tw="relative flex w-full h-full justify-center items-center">
        {/* Background */}
        ...
        <div tw="flex-col text-neutral-50">
          {/* Title */}
          <div tw="text-[60px]">{post?.title}</div>
          {/* Description */}
          <div tw="text-2xl max-w-4xl">{post?.description}</div>
          {/* Tags */}
          <div tw="flex mt-6 flex-wrap items-center text-3xl text-neutral-20">
            <div
              tw={`font-medium ${
